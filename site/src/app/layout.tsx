...
export const metadata: Metadata = {
	...
	description: "Auto-swap between Micro, Text, and Display optical size cuts based on computed font-size. Fills the gap CSS font-optical-sizing can’t cover. React and vanilla JS.",
